#!/usr/bin/env python3
# b6_smoke_gptoss120b.py — B6 冒烟 gpt-oss-120b (同套件同参数, DESIGN v1.1 决策 6 分型规则)
# 分型: 数值 2048 think / 概念 16384+精简提示 / 代码 6144 禁思考(qwen kwargs, gpt-oss 可能忽略)
import json, time, urllib.request

API = "http://127.0.0.1:8080/v1/chat/completions"
OUT = "/tmp/b6_smoke_gptoss120b.jsonl"
MODEL = "gpt-oss-120b"
