#!/usr/bin/env python3
# b6_smoke_qwen38_27b_fullctx_mxthink.py — 满上下文(262144)+最高强度思考(全题 thinking on, froggeric)
# 与默认对照: 默认 CTX=8192 + c2 禁思考; 本变体全开思考, 无 chat_template_kwargs 覆盖(依赖 froggeric 默认 enable_thinking=true)
import json, time, urllib.request

API = "http://127.0.0.1:18080/v1/chat/completions"
OUT = "/tmp/b6_smoke_qwen38_27b_fullctx_mxthink.jsonl"
...
QUESTIONS = [
    ...
    {
        "id": "dmx-c2", "type": "code", "max_tokens": 6144,
