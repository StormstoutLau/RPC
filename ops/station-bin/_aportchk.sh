#!/bin/bash
echo "== 8087 /v1/models =="
timeout 60 curl -s http://127.0.0.1:8087/v1/models -H "Authorization: Bearer ***REMOVED***" | head -c 400
echo
echo "== 8087 chat/completions 2+2 =="
timeout 90 curl -s http://127.0.0.1:8087/v1/chat/completions -H "Authorization: Bearer ***REMOVED***" -H "Content-Type: application/json" \
