...
| G14 | 版本协同矩阵（升级回归面） | 升级回归三件套（agent-cli-smoke + 插件加载 + 记忆读写）定义；G10 合并 | — | ⏳ **待办（事件驱动：升级窗口触发）** |

### 综合结论

**Agent 调研 §6 的 14 项缺口：8 项 ✅ 闭环、4 项 🔵 已覆盖/已定案、2 项 ⏳ 保留/待办。** 无 P1 级阻塞缺口。D6 wrapper 主路径（G1）与并发/恢复（G11/G12）两项"高"严重度缺口均已闭环。
...
| G14 / G10 升级回归矩阵 | 升级窗口三件套待执行 | 升级窗口开启 |
